...
### Summary: all C64 issues were firmware-only
...
**Note:** The directory navigation bug and the missing auto-load were both invisible in VICE and Arduino serial tests — only real C64 hardware exposed them.
