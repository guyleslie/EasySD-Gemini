...
This plugin expects an external player binary on the SD card:
  ...
  /PLUGINS/SIDPLAYER.PRG  (must be assembled for base address $9000)
...
SD card files required:
  - /PLUGINS/MUSPLUGIN.PRG  (built from Plugins/MusPlayer)
  - /PLUGINS/SIDPLAYER.PRG  (you build from the KickAssembler source by setting PLAYER_ADDRESS=$9000)
  - your songs: *.MUS
