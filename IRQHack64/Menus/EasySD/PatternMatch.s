...
PATTERN_INITIALIZED
	.BYTE 0		; Flag: 0 = not initialized, 1 = initialized

PATTERNMATCH:
	; Safety check: ensure pattern is initialized
	LDA PATTERN_INITIALIZED
	BNE PATTERN_OK
	; Pattern not initialized - return with error (C=0)
	CLC
	RTS
...
INITPATTERN
	...
	; Mark pattern as initialized
	LDA #$01
	STA PATTERN_INITIALIZED
